        ...
        <div className='mx-auto lg:w-2/3'>
            <div className=" container mx-auto flex flex-wrap md:p-5 flex-col md:flex-row items-center">
              <a className="max-sm:fixed flex title-font font-medium items-center text-gray-900 md:mb-0">
                <Image alt="mcdtoto slot" src='/logo.png' className='w-48 md:w-52 block' width='230' height='80' />
              </a>
          ...
          <Image alt="Mcdtoto : Link Paling Gacor Dan Link Gacor Terpercaya 2025" src='/banner.png' className='max-sm:mt-12 w-full block' width={757} height={411} />
          <h1 className='my-6 text-center'>Mcdtoto : Link Paling Gacor Dan Link Gacor Terpercaya 2025</h1>
          <div className='p-6 space-y-6 rounded-md glow-yellow mb-40'>
                      ...
                      <thead className='font-medium border-b border-[#EACD00] bg-gradient-to-r from-[#2E2E2E] via-[#606060] to-[#2E2E2E] '>
                        <tr>
                          <th colSpan={2} scope='col' className='px-6 py-3 text-center border-2 border-e border-[#EACD00] '>
                            <h2>Informasi mcdtoto Agen Slot Maxwin Online</h2>
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className='border-b border-[#EACD00] grid-cols-4'>
                          ...
                          <td className='px-2 py-3 w-3/4 whitespace-nowrap border-e border-[#EACD00] '>mcdtoto</td>
                        </tr>
            ...
            <ul className='text-[#FFD700] ml-4 leading-loose'>
              <li className='list-disc'>mcdtoto</li>
          ...
          <div className='bg-[#5B5B5B] text-center py-4'>
            <p className='text-sm text-white font-medium'>Copyright &copy; 2025 - Mcdtoto : Link Paling Gacor Dan Link Gacor Terpercaya 2025 </p>
          </div>
        </div>
      </div>
    </main>
